...
export function buildExterior(): {
  ...
  colliders.push(
    { minX: -22, maxX: 22, minZ: 33, maxZ: 34 }, // south
    { minX: -22, maxX: 22, minZ: -14, maxZ: -13 }, // north
    { minX: -17, maxX: -16, minZ: -14, maxZ: 34 }, // west
    { minX: 16, maxX: 17, minZ: -14, maxZ: 34 }, // east
  );
